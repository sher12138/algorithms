...
class AP_ParkingOut : public GeoParkingInit {
 public:
  AP_ParkingOut();
  ~AP_ParkingOut();
  /*functions*/
 ...
 private:
  ...
  bool AngularParkingNormalHeadOut(TrajectoryPoint end_pos,
                                   std::vector<TrajectoryPoint>& candidate_pos);
  bool AngularParkingUnNormalHeadOut(
      TrajectoryPoint end_pos, std::vector<TrajectoryPoint>& candidate_pos);

  bool AngularParkingNormalTailOut(TrajectoryPoint end_pos,
                                   std::vector<TrajectoryPoint>& candidate_pos);
  bool AngularParkingUnNormalTailOut(
      TrajectoryPoint end_pos, std::vector<TrajectoryPoint>& candidate_pos);
  ...
  void NormalHeadOutStep2(TrajectoryPoint& vel_pos,
                          ...
                          double final_x_val, double theta_final);
