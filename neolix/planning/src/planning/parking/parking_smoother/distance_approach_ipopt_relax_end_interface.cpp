...
bool DistanceApproachIPOPTRelaxEndInterface::GetNlpInfo(
...
bool DistanceApproachIPOPTRelaxEndInterface::GetBoundsInfo(int n, double* x_l,
                                                           double* x_u, int m,
                                                           double* g_l,
                                                           double* g_u) {
...
bool DistanceApproachIPOPTRelaxEndInterface::GetStartingPoint(
...
bool DistanceApproachIPOPTRelaxEndInterface::EvalF(int n, const double* x,
                                                   bool new_x,
                                                   double& obj_value) {
...
bool DistanceApproachIPOPTRelaxEndInterface::EvalGradF(int n, const double* x,
                                                       bool new_x,
                                                       double* grad_f) {
...
bool DistanceApproachIPOPTRelaxEndInterface::EvalG(int n, const double* x,
                                                   bool new_x, int m,
                                                   double* g) {
...
bool DistanceApproachIPOPTRelaxEndInterface::EvalJacG(int n, const double* x,
                                                      bool new_x, int m,
...
bool DistanceApproachIPOPTRelaxEndInterface::EvalJacGSer(int n, const double* x,
                                                         bool new_x, int m,
                                                         int nele_jac,
                                                         int* iRow, int* jCol,
                                                         double* values) {
...
bool DistanceApproachIPOPTRelaxEndInterface::EvalH(
...
void DistanceApproachIPOPTRelaxEndInterface::FinalizeSolution(
...
void DistanceApproachIPOPTRelaxEndInterface::GetOptimizationResults(
...
//***************    start ADOL-C part ***********************************
template <class T>
void DistanceApproachIPOPTRelaxEndInterface::EvalObj(int n, const T* x,
                                                     T* obj_value) {
  // Objective is :
  // min control inputs
  // min input rate
...
template <class T>
void DistanceApproachIPOPTRelaxEndInterface::EvalConstraints(int n, const T* x,
                                                             int m, T* g) {
  // state start index
  int state_index = state_start_index_;
...
bool DistanceApproachIPOPTRelaxEndInterface::CheckG(int n, const double* x,
...
void DistanceApproachIPOPTRelaxEndInterface::GenerateTapes(int n, int m,
                                                           int* nnz_jac_g,
                                                           int* nnz_h_lag) {
