...
DistanceApproachIPOPTRelaxEndSlackInterface::
  ...
  // TODO: use relax slacks from dual warm up
  ...
  weight_end_state_ = distance_approach_config_.weight_end_state_;
  weight_slack_ = distance_approach_config_.weight_slack_;
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::GetNlpInfo(
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::GetBoundsInfo(
  ...
  LOG_INFO("variable_index after adding slack s: {}", variable_index);
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::GetStartingPoint(
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::EvalF(int n, const double* x,
                                                        bool new_x,
                                                        double& obj_value) {
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::EvalGradF(int n,
                                                            const double* x,
                                                            bool new_x,
                                                            double* grad_f) {
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::EvalG(int n, const double* x,
                                                        bool new_x, int m,
                                                        double* g) {
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::EvalJacG(
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::EvalJacGSer(
    int n, const double* x, bool new_x, int m, int nele_jac, int* iRow,
    int* jCol, double* values) {
  LOG_ERROR("NOT READY");
  return false;
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::EvalH(
...
void DistanceApproachIPOPTRelaxEndSlackInterface::FinalizeSolution(
...
void DistanceApproachIPOPTRelaxEndSlackInterface::GetOptimizationResults(
  ...
  // TODO: extract slack variables for further study
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::CheckG(int n, const double* x,
                                                         int m,
                                                         const double* g) {
  int kN = n;
  int kM = m;
  ...
  if (m12 != num_of_constraints_) {
    LOG_ERROR("m12 [{}] != num_of_constraints_ [{}]", m12, num_of_constraints_);
    return false;
  }
  ...
  LOG_INFO("slack constraint to: {}", m12);
