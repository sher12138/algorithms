...
DualVariableWarmStartSlackOSQPInterface::
  ...
  beta_ = dualvariable_config_.osqp_config_.beta_;
}
...
void DualVariableWarmStartSlackOSQPInterface::GetOptimizationResults(
  ...
  *s_warm_up = slacks_;
  ...
  LOG_INFO("max_s: {:.4f}, mim_s: {:.4f}", max_s, min_s);
  return;
}
