...
class MotorwaySpeedConfilictMeetingDecider final
    : public ScenarioTaskInterface {
  DECLARE_SINGLETON(MotorwaySpeedConfilictMeetingDecider);

 public:
  virtual ~MotorwaySpeedConfilictMeetingDecider() override;
...
REGISTER_SCENARIO_TASK(MotorwaySpeedConfilictMeetingDecider);
}  // namespace planning
}  // namespace neodrive
