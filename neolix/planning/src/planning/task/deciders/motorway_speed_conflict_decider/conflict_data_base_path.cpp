...
ConflictDataBasePath::ConflictDataBasePath()
    : ConflictDataInterface("ConflictDataBaseOnPath") {}

std::vector<ConnectionConflictInfo>
ConflictDataBasePath::ComputeConflictMergeInData(TaskInfo& task_info) {
...
std::vector<ConnectionConflictInfo>
ConflictDataBasePath::ComputeConflictMeetingData(TaskInfo& task_info) {
  std::vector<ConnectionConflictInfo> ans{};
  const auto& traffic_conflict_zone_context =
      task_info.current_frame()
          ->outside_planner_data()
...
std::vector<ConnectionConflictInfo>
ConflictDataBasePath::ComputeConflictCustomData(TaskInfo& task_info) {
  std::vector<ConnectionConflictInfo> ans{};
  if (interactive_agent_ids_.empty()) {
    LOG_INFO("No Dynamic Obs!");
    return ans;
...
bool ConflictDataBasePath::CollisionCheckWithObstaclePolyline(
...
void ConflictDataBasePath::GetObsPredictionSegment(
    const InsidePlannerData& inside_data, const Obstacle& obstacle,
...
void ConflictDataBasePath::GetEmittedFromObsCenter(
...
bool ConflictDataBasePath::CheckFirstCollide(
...
void ConflictDataBasePath::GetFirstCollideInfo(
    const OutsidePlannerData* const outside_data,
...
bool ConflictDataBasePath::GetLaneMergingInfo(
...
void ConflictDataBasePath::GetAdcCornerPointCoordinate(
...
bool ConflictDataBasePath::CheckCollisionForDiverging(
