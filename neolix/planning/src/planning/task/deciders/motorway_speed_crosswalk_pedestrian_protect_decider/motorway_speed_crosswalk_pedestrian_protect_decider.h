...
class MotorwaySpeedCrosswalkPedestrainProtectDecider final
    : public ScenarioTaskInterface {
  DECLARE_SINGLETON(MotorwaySpeedCrosswalkPedestrainProtectDecider);

 public:
  virtual ~MotorwaySpeedCrosswalkPedestrainProtectDecider() override;
...
REGISTER_SCENARIO_TASK(MotorwaySpeedCrosswalkPedestrainProtectDecider);
