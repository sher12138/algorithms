...
namespace neodrive {
namespace planning {
class MotorwaySpeedObsExtend {
 public:
  ~MotorwaySpeedObsExtend() = default;
  MotorwaySpeedObsExtend() = default;
  MotorwaySpeedObsExtend(int id, double start_t, double end_t, double start_s_l,
