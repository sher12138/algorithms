...
class MotorwaySpeedLaneBorrowDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(MotorwaySpeedLaneBorrowDecider);

 public:
  virtual ~MotorwaySpeedLaneBorrowDecider() override;
...
REGISTER_SCENARIO_TASK(MotorwaySpeedLaneBorrowDecider);
