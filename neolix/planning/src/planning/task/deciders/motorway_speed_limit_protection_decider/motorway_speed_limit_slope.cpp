...
MotorwaySpeedLimitSlope::MotorwaySpeedLimitSlope()
    : MotorwaySpeedLimitInterface("motorway_speed_limit_slope") {}

void MotorwaySpeedLimitSlope::ComputeSpeedLimit(TaskInfo &task_info) {
