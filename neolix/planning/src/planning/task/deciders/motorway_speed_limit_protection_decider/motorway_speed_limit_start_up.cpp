...
MotorwaySpeedLimitStartUp::MotorwaySpeedLimitStartUp()
    : MotorwaySpeedLimitInterface("motorway_speed_limit_start_up") {}

void MotorwaySpeedLimitStartUp::ComputeSpeedLimit(TaskInfo &task_info) {
