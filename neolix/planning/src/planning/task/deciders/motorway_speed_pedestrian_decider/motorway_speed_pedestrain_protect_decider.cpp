#include "motorway_speed_pedestrain_protect_decider.h"
...
MotorwaySpeedPedestrianProtectDecider::MotorwaySpeedPedestrianProtectDecider() {
  name_ = "MotorwaySpeedPedestrianProtectDecider";
}

MotorwaySpeedPedestrianProtectDecider::
    ~MotorwaySpeedPedestrianProtectDecider() {
  Reset();
}

ErrorCode MotorwaySpeedPedestrianProtectDecider::Execute(TaskInfo& task_info) {
...
void MotorwaySpeedPedestrianProtectDecider::SaveTaskResults(
    TaskInfo& task_info) {
...
bool MotorwaySpeedPedestrianProtectDecider::Process(TaskInfo& task_info) {
...
bool MotorwaySpeedPedestrianProtectDecider::Init(TaskInfo& task_info) {
...
bool MotorwaySpeedPedestrianProtectDecider::DataCheck(TaskInfo& task_info) {
...
void MotorwaySpeedPedestrianProtectDecider::ClearObsHistoryInfo() {
...
bool MotorwaySpeedPedestrianProtectDecider::ComputeFrontCautionBoundAlongPath(
...
void MotorwaySpeedPedestrianProtectDecider::ExtractPedestrianInfo(
    TaskInfo& task_info) {
...
void MotorwaySpeedPedestrianProtectDecider::UpdataDynPedestrianInfo(
...
double
MotorwaySpeedPedestrianProtectDecider::ComputeStaticPedestrianSpeedLimit() {
...
double
MotorwaySpeedPedestrianProtectDecider::ComputeDynamicPedestrianSpeedLimit() {
...
bool MotorwaySpeedPedestrianProtectDecider::HasOverlapWithAttentionBound(
...
std::array<double, 3>
MotorwaySpeedPedestrianProtectDecider::ComputeStaticEndState(
...
std::array<double, 3>
MotorwaySpeedPedestrianProtectDecider::ComputeDynamicEndState(
