...
class MotorwaySpeedReversedObsDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(MotorwaySpeedReversedObsDecider);

 public:
  virtual ~MotorwaySpeedReversedObsDecider() override;
 ...
 private:
  ...
  std::vector<DynamicObsCautionInfo>* dynamic_obs_caution_infos_ptr_{nullptr};
...
REGISTER_SCENARIO_TASK(MotorwaySpeedReversedObsDecider);
