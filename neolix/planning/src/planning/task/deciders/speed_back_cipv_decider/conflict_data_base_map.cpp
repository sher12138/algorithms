...
BackDataBaseMap::BackDataBaseMap() : BackDataInterface("BackDataBaseOnPath") {}

std::vector<ConnectionConflictInfo> BackDataBaseMap::ComputeConflictMeetingData(
    TaskInfo& task_info) {
...
std::vector<ConnectionConflictInfo> BackDataBaseMap::ComputeConflictMergeInData(
    TaskInfo& task_info) {
