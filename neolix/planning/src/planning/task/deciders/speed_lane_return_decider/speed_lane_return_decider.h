...
class SpeedLaneReturnDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedLaneReturnDecider);

 public:
  virtual ~SpeedLaneReturnDecider() override;
 ...
 private:
  ...
  bool ReturnStatus(TaskInfo& task_info);
...
REGISTER_SCENARIO_TASK(SpeedLaneReturnDecider);
