#include "speed_obs_overtake_closely_decider.h"
...
SpeedObsOvertakeCloselyDecider::SpeedObsOvertakeCloselyDecider() {
  name_ = "SpeedObsOvertakeCloselyDecider";
}

SpeedObsOvertakeCloselyDecider::~SpeedObsOvertakeCloselyDecider() { Reset(); }

ErrorCode SpeedObsOvertakeCloselyDecider::Execute(TaskInfo& task_info) {
...
void SpeedObsOvertakeCloselyDecider::SaveTaskResults(TaskInfo& task_info) {
...
bool SpeedObsOvertakeCloselyDecider::Process(TaskInfo& task_info) {
  if (!Init(task_info)) {
  ...
  // which are safe but will cause hard brake in IDM, and then give target
  // limited speed.
...
bool SpeedObsOvertakeCloselyDecider::Init(TaskInfo& task_info) {
...
bool SpeedObsOvertakeCloselyDecider::DataCheck(TaskInfo& task_info) {
...
void SpeedObsOvertakeCloselyDecider::ClearObsHistoryInfo() {
  // clear obs_s_info_
...
bool SpeedObsOvertakeCloselyDecider::InitForntCollisionCheckAreaAlongPath(
...
bool SpeedObsOvertakeCloselyDecider::InitCollisionCheckArea(
...
ErrorCode SpeedObsOvertakeCloselyDecider::DynamicObstacleCollisionRiskCheck(
    TaskInfo& task_info) {
  if (task_info.last_frame() == nullptr) {
    return ErrorCode::PLANNING_OK;
  }
...
void SpeedObsOvertakeCloselyDecider::CheckIfDynamicToStatic(
    TaskInfo& task_info) {
...
bool SpeedObsOvertakeCloselyDecider::AdcRightCollisionCheck(
  ...
  auto& speed_backup_ignore_dynamic_obs_id =
      outside_data->speed_obstacle_context.speed_backup_ignore_dynamic_obs_id;
...
bool SpeedObsOvertakeCloselyDecider::RightSidePrepareData(
...
bool SpeedObsOvertakeCloselyDecider::AdcFrontCollisionCheck(
    const InsidePlannerData& inside_data, const Obstacle* const obs,
...
void SpeedObsOvertakeCloselyDecider::DealFrontObs(
...
void SpeedObsOvertakeCloselyDecider::FindLowCollisionPointWithPolygon(
...
bool SpeedObsOvertakeCloselyDecider::AdcBackCollisionCheck(
    const InsidePlannerData& inside_data, const Obstacle* const obs,
    OutsidePlannerData* const outside_data) {
  auto& dp_st_map_ignore_dynamic_obs_id =
      outside_data->speed_obstacle_context.dp_st_map_ignore_dynamic_obs_id;
...
bool SpeedObsOvertakeCloselyDecider::AdcLeftCollisionCheck(
    const InsidePlannerData& inside_data, const Obstacle* const obs,
    OutsidePlannerData* const outside_data) {
...
bool SpeedObsOvertakeCloselyDecider::LeftSidePrepareData(
    const InsidePlannerData& inside_data,
...
void SpeedObsOvertakeCloselyDecider::DealSideBigObs(
...
void SpeedObsOvertakeCloselyDecider::DealSideSmallObs(
    const Obstacle* const obs,
    std::unordered_map<int, DynamicObsCollisionCheckData>&
        side_dynamic_obstacles_data) {
  auto& side_dynamic_obs_data = side_dynamic_obstacles_data[obs->id()];
...
void SpeedObsOvertakeCloselyDecider::ObsOvertakeAdc(
    const Obstacle* const obs,
...
void SpeedObsOvertakeCloselyDecider::AdcOvertakeObs(
    const Obstacle* const obs,
    DynamicObsCollisionCheckData& side_dynamic_obs_data) {
...
void SpeedObsOvertakeCloselyDecider::GetCollideDecisionObs(
    TaskInfo& task_info) {
...
bool SpeedObsOvertakeCloselyDecider::IsEasyHardBrakeObs(
    const Obstacle* const obs) {
...
void SpeedObsOvertakeCloselyDecider::UpdataObsLongInfo(
...
void SpeedObsOvertakeCloselyDecider::UpdataObsCutinInfo(
    TaskInfo& task_info, const Obstacle* const obs) {
...
void SpeedObsOvertakeCloselyDecider::UpdataObsHeadingInfo(
    TaskInfo& task_info, const Obstacle* const obs) {
...
bool SpeedObsOvertakeCloselyDecider::IsAdcNearJunction(TaskInfo& task_info) {
...
void SpeedObsOvertakeCloselyDecider::GetObsLongResult(const Obstacle* const obs,
...
void SpeedObsOvertakeCloselyDecider::GetObsLatResult(const Obstacle* const obs,
                                                     LatResult& lat_res) {
...
void SpeedObsOvertakeCloselyDecider::GetObsTurningInfo(
