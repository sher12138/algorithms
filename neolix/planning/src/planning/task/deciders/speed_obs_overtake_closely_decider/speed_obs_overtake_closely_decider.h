...
class SpeedObsOvertakeCloselyDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedObsOvertakeCloselyDecider);

 public:
  virtual ~SpeedObsOvertakeCloselyDecider() override;
...
REGISTER_SCENARIO_TASK(SpeedObsOvertakeCloselyDecider);
}  // namespace planning
}  // namespace neodrive
