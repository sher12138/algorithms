...
class SpeedPedestrianProtectDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedPedestrianProtectDecider);

 public:
  virtual ~SpeedPedestrianProtectDecider() override;
...
REGISTER_SCENARIO_TASK(SpeedPedestrianProtectDecider);
