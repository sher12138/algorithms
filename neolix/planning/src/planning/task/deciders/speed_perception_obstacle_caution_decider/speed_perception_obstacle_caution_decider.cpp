#include "speed_perception_obstacle_caution_decider.h"
...
SpeedPerceptionObstacleCautionDecider::SpeedPerceptionObstacleCautionDecider() {
  name_ = "SpeedPerceptionObstacleCautionDecider";
}

SpeedPerceptionObstacleCautionDecider::
    ~SpeedPerceptionObstacleCautionDecider() {
  Reset();
}

ErrorCode SpeedPerceptionObstacleCautionDecider::Execute(TaskInfo& task_info) {
...
void SpeedPerceptionObstacleCautionDecider::SaveTaskResults(
    TaskInfo& task_info) {
...
void SpeedPerceptionObstacleCautionDecider::Reset(){};

bool SpeedPerceptionObstacleCautionDecider::Init(TaskInfo& task_info) {
...
bool SpeedPerceptionObstacleCautionDecider::BuildPathAdcBoundingBoxes(
...
bool SpeedPerceptionObstacleCautionDecider::Process(TaskInfo& task_info) {
...
ErrorCode SpeedPerceptionObstacleCautionDecider::StaticObsCollisionCheck(
...
ErrorCode
SpeedPerceptionObstacleCautionDecider::CollisionCheckObstacleWithoutTrajectory(
...
bool SpeedPerceptionObstacleCautionDecider::ComputeSpeedLimit(
    TaskInfo& task_info) {
