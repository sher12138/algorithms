...
class SpeedPerceptionObstacleCautionDecider final
    : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedPerceptionObstacleCautionDecider);

 public:
  virtual ~SpeedPerceptionObstacleCautionDecider() override;
...
REGISTER_SCENARIO_TASK(SpeedPerceptionObstacleCautionDecider);
