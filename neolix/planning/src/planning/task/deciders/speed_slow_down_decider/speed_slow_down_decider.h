...
class SpeedSlowDownDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedSlowDownDecider);

 public:
  virtual ~SpeedSlowDownDecider() override;
...
REGISTER_SCENARIO_TASK(SpeedSlowDownDecider);
