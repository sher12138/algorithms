...
class SpeedStaticObsJumpDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedStaticObsJumpDecider);

 public:
  virtual ~SpeedStaticObsJumpDecider() override;
...
REGISTER_SCENARIO_TASK(SpeedStaticObsJumpDecider);
