...
class SpeedStopToGoFreespaceDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedStopToGoFreespaceDecider);

 public:
  virtual ~SpeedStopToGoFreespaceDecider() override;
...
REGISTER_SCENARIO_TASK(SpeedStopToGoFreespaceDecider);
}  // namespace planning
}  // namespace neodrive
