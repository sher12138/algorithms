...
class SpeedUnprotectedTurnDecider final : public ScenarioTaskInterface {
  DECLARE_SINGLETON(SpeedUnprotectedTurnDecider);

 public:
  virtual ~SpeedUnprotectedTurnDecider() override;
...
REGISTER_SCENARIO_TASK(SpeedUnprotectedTurnDecider);
}  // namespace planning
}  // namespace neodrive